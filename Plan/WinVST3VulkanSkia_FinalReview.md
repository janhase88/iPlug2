...
- **Swapchain alignment** – `CreateOrResizeVulkanSwapchain()` records the chosen extents and whether the host `currentExtent` was bypassed, enabling reviewers to confirm Vulkan surfaces match the logical size × physical DPI even while the HWND stays at the host scale.【F:IGraphics/Platforms/IGraphicsWin.cpp†L3823-L4245】
