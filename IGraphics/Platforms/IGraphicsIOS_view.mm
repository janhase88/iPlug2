...
- (void)viewDidLoad
{
  ...
  for (int i = 0; i < numItems; ++i)
  {
    ...
    if (mMenu->GetPrefix())
    {
      ...
      {
      case 1:
        prefixString = [NSString stringWithFormat:@"%1d: ", i + 1];
        break;
      case 2:
        prefixString = [NSString stringWithFormat:@"%02d: ", i + 1];
        break;
      case 3:
        prefixString = [NSString stringWithFormat:@"%03d: ", i + 1];
        break;
      case 0:
      default:
        prefixString = [NSString stringWithUTF8String:""];
        break;
      }
...
- (id)initWithIGraphics:(IGraphicsIOS*)pGraphics
{
  ...
  UIHoverGestureRecognizer* hoverGestureRecognizer = [[UIHoverGestureRecognizer alloc] initWithTarget:self action:@selector(onHoverGesture:)];
...
- (void)onSwipeGesture:(UISwipeGestureRecognizer*)recognizer
{
  ...
  case UISwipeGestureRecognizerDirectionLeft:
    info.type = EGestureType::SwipeLeft;
    break;
  case UISwipeGestureRecognizerDirectionRight:
    info.type = EGestureType::SwipeRight;
    break;
  case UISwipeGestureRecognizerDirectionUp:
    info.type = EGestureType::SwipeUp;
    break;
  case UISwipeGestureRecognizerDirectionDown:
    info.type = EGestureType::SwipeDown;
    break;
  default:
    break;
  }
...
- (void)traitCollectionDidChange:(UITraitCollection*)previousTraitCollection
{
  ...
  if (mGraphics)
  {
    mGraphics->OnAppearanceChanged([self.traitCollection userInterfaceStyle] == UIUserInterfaceStyleDark ? EUIAppearance::Dark : EUIAppearance::Light);
  }
}
