 ...
 * @param func The function to call */
  ...
  virtual float GetWindowVirtualizationScale() const { return 1.f; }
...
protected:
  ...
  virtual APIBitmap* CreateAPIBitmap(int width, int height, float scale, double drawScale, bool cacheable = false, int MSAASampleCount = 0) = 0;
