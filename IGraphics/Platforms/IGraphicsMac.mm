...
PlatformFontPtr IGraphicsMac::LoadPlatformFont(const char* fontID, const char* fontName, ETextStyle style) { return CoreTextHelpers::LoadPlatformFont(fontID, fontName, style); }
...
bool IGraphicsMac::WindowIsOpen() { return mView; }
...
const char* IGraphicsMac::GetPlatformAPIStr() { return "Cocoa"; }
...
void IGraphicsMac::PromptForFile(WDL_String& fileName, WDL_String& path, EFileAction action, const char* ext, IFileDialogCompletionHandlerFunc completionHandler)
{
  ...
  if (completionHandler)
  {
    ...
    [(NSSavePanel*)pPanel beginSheetModalForWindow:pWindow
...
void IGraphicsMac::PromptForDirectory(WDL_String& dir, IFileDialogCompletionHandlerFunc completionHandler)
{
  ...
  if (completionHandler)
  {
    ...
    [panelOpen beginSheetModalForWindow:pWindow
                      completionHandler:^(NSModalResponse response) {
