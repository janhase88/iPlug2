...
#ifndef IGRAPHICS_SANDBOX_IMAGE_CACHE
#define IGRAPHICS_SANDBOX_IMAGE_CACHE IGRAPHICS_SANDBOX_DRAW
#endif
IPLUG_SANDBOX_REQUIRE_BOOL(IGRAPHICS_SANDBOX_IMAGE_CACHE);

#ifndef IGRAPHICS_SANDBOX_SKIA_FONT_CACHE
#define IGRAPHICS_SANDBOX_SKIA_FONT_CACHE IGRAPHICS_SANDBOX_DRAW
#endif
IPLUG_SANDBOX_REQUIRE_BOOL(IGRAPHICS_SANDBOX_SKIA_FONT_CACHE);
...
IPLUG_SANDBOX_ENSURE_CHILD(IGRAPHICS_SANDBOX_IMAGE_CACHE, IGRAPHICS_SANDBOX_DRAW);
IPLUG_SANDBOX_ENSURE_CHILD(IGRAPHICS_SANDBOX_SKIA_FONT_CACHE, IGRAPHICS_SANDBOX_DRAW);
