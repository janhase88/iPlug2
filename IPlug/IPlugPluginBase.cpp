...
void IPluginBase::GetHostVersionStr(WDL_String& str) const { GetVersionStr(mHostVersion, str); }
...
void IPluginBase::DefaultParamValues() { DefaultParamValues(0, NParams() - 1); }
...
void IPluginBase::RandomiseParamValues() { RandomiseParamValues(0, NParams() - 1); }
