...
| Skia drawing caches | `IGRAPHICS_SANDBOX_DRAW` | `IGRAPHICS_SANDBOX_TEXTURE_CACHE`, `IGRAPHICS_SANDBOX_IMAGE_CACHE`, `IGRAPHICS_SANDBOX_SKIA_FONT_CACHE`, `IGRAPHICS_SANDBOX_FONT_FACTORY`, `IGRAPHICS_SANDBOX_UNICODE_HELPER` | `IGraphics/Drawing/IGraphicsSkia.cpp`, `IGraphics/IGraphics.cpp` | Default ties the Skia caches to the owning graphics object; child macros let integrators selectively share heavy-weight factories or caches. |
