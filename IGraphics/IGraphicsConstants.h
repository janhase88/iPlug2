...
#ifndef IGRAPHICS_DPI_LOGGING
#define IGRAPHICS_DPI_LOGGING 1
#endif

#if IGRAPHICS_DPI_LOGGING
#define IGRAPHICS_DPI_TRACE(...) DBGMSG(__VA_ARGS__)
#else
#define IGRAPHICS_DPI_TRACE(...) do { } while (0)
#endif

#ifndef IGRAPHICS_SKIA_FORCE_DEVICE_SCALE_MILLIS
#define IGRAPHICS_SKIA_FORCE_DEVICE_SCALE_MILLIS 1500
#endif
